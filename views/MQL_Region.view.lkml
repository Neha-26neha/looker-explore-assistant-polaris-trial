view: MQL_Region {
  ...
  sql_table_name: `google.com:project-polaris-ai.project_polaris_ai_ds.MQL_Region` ;;
...
# MQL_Date Dimension Group
  ...
  dimension: country_code {
    ...
    label: "Sales Sub Region Code"
    description: "This attribute give details about Sales Region Code"
    tags: ["Sales Sub Region Code", "Sub Region Code", "Region Code"]
  }
